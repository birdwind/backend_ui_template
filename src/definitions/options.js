...
export const DialogTypeOptions = [
  { id: DialogType.Create, name: i18n.t('system.ui.dialog.create') },
  { id: DialogType.Update, name: i18n.t('system.ui.dialog.update') }
]

export const StatusOptions = [
  { id: 0, name: i18n.t('common.status.disabled'), color: 'danger' },
  { id: 1, name: i18n.t('common.status.enabled'), color: 'success' }
]

export const StatusReversOptions = [
  { id: 0, name: i18n.t('common.status.enabled'), color: 'success' },
  { id: 1, name: i18n.t('common.status.disabled'), color: 'danger' }
]
...
// 封禁狀態選項
export const BannedStateOptions = [
  { id: 0, name: i18n.t('options.banned.no') },
  { id: 1, name: i18n.t('options.banned.yes') }
]

// 封禁狀態選項
export const EnableStateOptions = [
  { id: 0, name: i18n.t('common.disable') },
  { id: 1, name: i18n.t('common.enable') }
]
